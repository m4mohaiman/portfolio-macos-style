...
const Safari = () => {
    return (<>
        <div id="window-header">
            <WindowControlls target="safari"></WindowControlls>
            ...
            <div className="flex-1 flex-center gap-3">
                ...
                <div className="search">
                    ...
                    <input type="text" placeholder="Search or enter website address" className="flex-1"/>
                </div>
            </div>
        ...
        <div className="blog">
            ...
            <div className="space-y-8">
                {blogPosts.map(({id, image, title, date, link}) => (<div key={id} className="blog-post">
